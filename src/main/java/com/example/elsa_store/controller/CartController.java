...
public class CartController {
    ...
    @PostMapping("/items")
    public ApiResponse<CartResponse> addItem(@RequestParam Long userId,
                                @RequestBody AddToCartRequest req) {
        return cartService.addItem(userId, req);
    }

    @PutMapping("/items/{cartItemId}")
    public ApiResponse<CartResponse> updateQty(@RequestParam Long userId,
    ...
    public ApiResponse<CartResponse> removeItem(@RequestParam Long userId,
                                   @PathVariable Long cartItemId) {
